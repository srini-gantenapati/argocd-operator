...
func (in *ArgoCDSpec) DeepCopyInto(out *ArgoCDSpec) {
	*out = *in
	...
	out.WebTerminal = in.WebTerminal
	if in.Banner != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDWebTerminalSpec) DeepCopyInto(out *ArgoCDWebTerminalSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDWebTerminalSpec.
func (in *ArgoCDWebTerminalSpec) DeepCopy() *ArgoCDWebTerminalSpec {
	if in == nil {
		return nil
	}
	out := new(ArgoCDWebTerminalSpec)
	in.DeepCopyInto(out)
	return out
}
